...
data BreakF x = BreakComputeF x | BreakReturnF x

type Exp = Fix (Sum Lam.ExpF BreakF)

{-# COMPLETE Var, Lambda, Apply, BreakCompute, BreakReturn #-}
...
pattern BreakReturn :: Exp -> Exp
pattern BreakReturn e = Fix (InR (BreakReturnF e))
